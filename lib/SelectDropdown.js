...
var SelectDropdown = (function (_super) {
    ...
    SelectDropdown.prototype.render = function () {
        var _a = this.props, inputId = _a.inputId, hasInputFocus = _a.hasInputFocus, value = _a.value, placeholder = _a.placeholder, options = _a.options, selectProps = _a.selectProps, onChange = _a.onChange, onFocus = _a.onFocus, onBlur = _a.onBlur, promiseOptions = _a.promiseOptions, defaultOptions = _a.defaultOptions, cacheOptions = _a.cacheOptions;
        var Select = selectProps && selectProps.isCreatable ? (promiseOptions ? async_creatable_1.default : creatable_1.default) : react_select_1.default;
        var optionsProps = {};
        if (promiseOptions) {
...
var promiseOptions = function (inputValue) {
