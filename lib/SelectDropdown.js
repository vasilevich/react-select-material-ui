...
var SelectDropdown = (function (_super) {
    ...
    SelectDropdown.prototype.render = function () {
        var _a = this.props, inputId = _a.inputId, hasInputFocus = _a.hasInputFocus, value = _a.value, placeholder = _a.placeholder, options = _a.options, selectProps = _a.selectProps, onChange = _a.onChange, onFocus = _a.onFocus, onBlur = _a.onBlur, loadOptions = _a.loadOptions, defaultOptions = _a.defaultOptions, cacheOptions = _a.cacheOptions;
        var Select = selectProps && selectProps.isCreatable ? (loadOptions ? async_creatable_1.default : creatable_1.default) : (loadOptions ? async_1.default : react_select_1.default);
        var optionsProps = {};
        if (loadOptions) {
        ...
        return (React.createElement(Select, __assign({ inputId: inputId, isValidNewOption: this.isValidNewOption, captureMenuScroll: false, createOptionPosition: "first" }, selectProps, { value: value, placeholder: placeholder, styles: SelectDropdownStyles_1.getStyles(selectProps, hasInputFocus), noOptionsMessage: this.noOptionsMessage, onChange: onChange, onFocus: onFocus, onBlur: onBlur }, optionsProps)));
    };
...
var loadOptions = function (inputValue) {
